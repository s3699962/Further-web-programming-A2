...
async function seedData() {
  ...
  //seed likes and dislikes
  await db.post_like.create({ userEmail: "jroga@gmail.com", postId: 1 , like: false});
  await db.comment_like.create({ userEmail: "jroga@gmail.com", commentId: 1, like: true});
